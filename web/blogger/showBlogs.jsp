    ...
    <div class="templatemo-flex-row">
      ...
      <jsp:include page="header.jsp"></jsp:include>
        <div class="templatemo-content-container">
            ...
            <% ArrayList<Blog> blist = new BlogDao().getAllBlogsByBlogger(blogger.getId());
            for(Blog blog : blist){%>
            <tr>
                    <td><%=blog.getId()%></td>
                    <td><%=blog.getTitle()%></td>
                    ...
                    <th class="<%=blog.getStatus().equals("pending")?"text-danger font-weight-bold":""%>">
                        <%=blog.getStatus()%></th>
                    <td><a href="update1.jsp?id=<%=blog.getId()%>" class="btn btn-success" style="width:150px" <%=blog.getStatus().equals("approved")?"disabled":""%>>View and Edit</a> <br/> <br/>
                        <a href="#" class="btn btn-primary" style="width:150px"> Request to Approve<td>
                </tr>
                <%}%>
            </table>
        </div>
